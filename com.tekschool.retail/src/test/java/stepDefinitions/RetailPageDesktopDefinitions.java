...
public class RetailPageDesktopDefinitions extends Base {
	...
	public void user_enter_yourname_name(String RazMohammad) throws Throwable {
		desktoppageobj.enterName(RazMohammad);
		WebDriverUtility.wait(3000);
		WebDriverUtility.screenShot();
	}

	@When("^User enter yourReview '(.+)'")
	public void user_enter_yourReview_I_Love_TekSchool_Products_And_Lessons(String ILoveTecSchoolProducts)
			throws Throwable {
		desktoppageobj.enterReview(ILoveTecSchoolProducts);
		WebDriverUtility.screenShot();
	}
